...
@Settings(settingsFile = "buffalo.json")
public class Buffalo extends Herbivorous {

    private static final AnimalUnit ANIMAL_UNIT = AnimalSettingsUtil.getAnimalUnit(Buffalo.class);
    ...
    public int getNumberOfMovements() {
        return Buffalo.getAnimalUnit().speed();
    }
}
